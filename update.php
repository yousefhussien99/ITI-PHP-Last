...
<body>
    ...
    <main>
        ...
        <form action="update.php" method="post">
            ...
            <input type="text" name="email" id="email" placeholder="Email" value = "<?php echo $_GET['id']?>" readonly>
...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['room_number']) && isset($_POST['ext'])){
    $name = $_POST['name'];
    $email = $_POST['email'];
    ...
    $ext = $_POST['ext'];
    $db = new Db();
    $db->update($name,$email,$password,$room_number,$ext);
}
?>